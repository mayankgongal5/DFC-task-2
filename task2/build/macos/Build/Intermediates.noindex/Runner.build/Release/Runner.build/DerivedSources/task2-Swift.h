...
#ifndef TASK2_SWIFT_H
#define TASK2_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="task2",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5task211AppDelegate")
...
SWIFT_CLASS("_TtC5task217MainFlutterWindow")
